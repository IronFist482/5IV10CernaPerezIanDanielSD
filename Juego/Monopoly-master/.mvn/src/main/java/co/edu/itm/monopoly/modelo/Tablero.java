...
public class Tablero {
    ...
    public Tablero() {
        ...
        casilla4 = new Villanos("Frezzer", 4, 40, 355);//casilla3
        ...
        casilla9 = new Villanos("Kaio", 9, 163, 50);//casilla8
        ...
        casilla13 = new Villanos("Cell", 13, 456, 50);//casilla12
        ...
        casilla17 = new Villanos("Estamos pensando el villano jsjs", 17, 684, 207);//casilla16
        ...
        casilla21 = new Villanos("Majin Buu", 21, 684, 500);//casilla20
        ...
        casilla24 = new Heroes("Goku", 24, 456, 563);//casilla23
        ...
        casilla28 = new Villanos("Broly", 28, 163, 563);//casilla27
