...
const errors_1 = require("../listeners/errors");
...
const file = path_1.default.join(__dirname, 'statements.txt');
 ...
 */
function versionMatches(statement, serverVersion) {
...
describe('Parser', () => {
    it('is a constructor', () => {
        ...
        expect(parser).toBeInstanceOf(parser_1.default);
    });
    ...
    describe('parser.parse()', () => {
        ...
        it('parses unfinished double quotes with a lexer error', () => {
            ...
            expect(result.lexerError).toBeInstanceOf(errors_1.LexerError);
            expect((_a = result.lexerError) === null || _a === void 0 ? void 0 : _a.message).toBe('Unfinished double quoted string literal');
            expect((_b = result.lexerError) === null || _b === void 0 ? void 0 : _b.data).toMatchObject({
                offset: 1,
                position: {
                    character: 0,
                    line: 1
        ...
        it('parses unfinished single quotes with a lexer error', () => {
            ...
            const result = parser.parse(`'`);
            expect(result.lexerError).toBeInstanceOf(errors_1.LexerError);
            expect((_a = result.lexerError) === null || _a === void 0 ? void 0 : _a.message).toBe('Unfinished single quoted string literal');
            expect((_b = result.lexerError) === null || _b === void 0 ? void 0 : _b.data).toMatchObject({
                offset: 1,
                position: {
                    character: 0,
        ...
        it('parses unfinished back tick quotes with a lexer error', () => {
            ...
            const result = parser.parse('`');
            expect(result.lexerError).toBeInstanceOf(errors_1.LexerError);
            expect((_a = result.lexerError) === null || _a === void 0 ? void 0 : _a.message).toBe('Unfinished back tick quoted string literal');
            expect((_b = result.lexerError) === null || _b === void 0 ? void 0 : _b.data).toMatchObject({
                offset: 1,
                position: {
                    character: 0,
        ...
        it('supports specifying parse context', () => {
            const parser = new parser_1.default();
            const result = parser.parse('FROM users', rule_name_1.RuleName.fromClause);
            expect(result.lexerError).toBeUndefined();
            expect(result.parserError).toBeUndefined();
        });
        const parser = new parser_1.default({ mode: __1.SqlMode.AnsiQuotes, charsets });
